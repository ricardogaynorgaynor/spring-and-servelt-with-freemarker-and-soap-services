...
@XmlRootElement(name = "allStudentCourseByStudentIDAcademicYear", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllStudentCourseByStudentIDAcademicYear {
