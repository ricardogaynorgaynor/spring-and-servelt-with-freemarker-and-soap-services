...
@XmlRootElement(name = "allOccurrenceByModulesCodeByAcademicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllOccurrenceByModulesCodeByAcademicPeriod {
