...
@XmlRootElement(name = "allLessonTypeByModuleCodeByAcademicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllLessonTypeByModuleCodeByAcademicPeriod {
