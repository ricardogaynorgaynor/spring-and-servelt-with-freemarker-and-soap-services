...
@XmlRootElement(name = "allLecturersWithOccurrenceLessonTypeByModulesCodeByAcademicPeriodBy", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllLecturersWithOccurrenceLessonTypeByModulesCodeByAcademicPeriodBy {
