...
@XmlRootElement(name = "allLecturersByProgrammeByAcademicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllLecturersByProgrammeByAcademicPeriod {
