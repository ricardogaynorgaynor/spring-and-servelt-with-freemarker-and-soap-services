...
@XmlRootElement(name = "allStudentCourseByStudentIDAcdemicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllStudentCourseByStudentIDAcdemicPeriod {
