...
@XmlRootElement(name = "allCourseCodeForModulesByModuleCodeByAcademicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllCourseCodeForModulesByModuleCodeByAcademicPeriod {
