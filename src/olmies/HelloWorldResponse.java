...
@XmlRootElement(name = "HelloWorldResponse", namespace = "http://olmiesservice.utech.edu.jm/")
public class HelloWorldResponse {

    @XmlElement(name = "HelloWorldResult", namespace = "http://olmiesservice.utech.edu.jm/")
