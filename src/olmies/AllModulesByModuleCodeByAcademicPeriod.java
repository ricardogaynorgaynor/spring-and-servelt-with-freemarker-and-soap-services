...
@XmlRootElement(name = "allModulesByModuleCodeByAcademicPeriod", namespace = "http://olmiesservice.utech.edu.jm/")
public class AllModulesByModuleCodeByAcademicPeriod {
